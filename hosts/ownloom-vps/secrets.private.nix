...
#
#   git update-index --skip-worktree hosts/ownloom-vps/secrets.private.nix
#
...
_: {
  services.ownloom-code-server.hashedPassword = "$argon2i$v=19$m=4096,t=3,p=1$REPLACE_WITH_REAL_SALT$REPLACE_WITH_REAL_HASH";
}
