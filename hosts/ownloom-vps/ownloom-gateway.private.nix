# ownloom-gateway.private.nix — WhatsApp transport owner allowlist.
#
...
#
#   git update-index --skip-worktree hosts/ownloom-vps/ownloom-gateway.private.nix
#
# to keep your local edits out of commits.
#
# Phone numbers must use E.164 format (e.g. +15550001234).
_: {
  services.ownloom-gateway.settings.transports.whatsapp = {
    enable = false;
