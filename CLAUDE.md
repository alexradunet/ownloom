...
- **Services**: `services/` — containerized (llm, stt, matrix, element, dufs) services. Scaffolded from template. NetBird is a system RPM. Metadata in `services/catalog.yaml`
