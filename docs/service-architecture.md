...
| **Service** | A standalone process needs to run independently of Pi's session | Lemonade (unified local AI), WhatsApp bridge (always-on), dufs (WebDAV) | Medium — systemd unit, resource allocation |
