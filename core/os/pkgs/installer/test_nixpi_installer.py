...
class NixpiInstallerTests(unittest.TestCase):
    ...
    def test_prepare_artifacts_generates_managed_user_install(self):
        ...
        self.assertIn('nixpi.primaryUser = "alex";', artifacts["nixpi_appliance_module"])
        self.assertIn('nixpi.install.mode = "managed-user";', artifacts["nixpi_appliance_module"])
        self.assertIn('nixpi.createPrimaryUser = true;', artifacts["nixpi_appliance_module"])
